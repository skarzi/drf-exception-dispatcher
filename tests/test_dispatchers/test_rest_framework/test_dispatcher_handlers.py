...
def test_set_rollback_disabled(mocker):
    ...
    settings_mock = mocker.patch(
        ...
        EXCEPTION_DISPATCHER_SET_ROLLBACK=False,
    )
    # unset parser import path so default parser could be used
    del settings_mock.EXCEPTION_DISPATCHER_API_EXCEPTION_PARSER  # noqa: WPS420
